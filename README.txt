...
== 1.3.3 == Released: on Sep 06, 2018

* Fix: Discount percentage calculation.

== 1.3.2 == Released: on Sep 06, 2018

* New: Show additional text before products list.

== 1.3.1 == Released: on Sep 05, 2018

* Fix: Update meta error with PHP 7.2.

== 1.3.0 == Released: on Sep 04, 2018
...
== 1.0.6 == Released on Jun 10, 2016

* New: Support to WooCommerce 2.6 RC1.
* Update: Plugin core.

== 1.0.5 == Released on Apr 27, 2016
